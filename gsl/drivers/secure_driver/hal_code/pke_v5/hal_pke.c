...
td_bool wait_free_condition(const td_void *param __attribute__((unused)));
...
td_s32 hal_pke_wait_free_int(void)
{
    ...
    /* wait ready */
    ret = g_pke_wait_event.wait_func(g_pke_wait_event.wait, wait_free_condition, TD_NULL,
